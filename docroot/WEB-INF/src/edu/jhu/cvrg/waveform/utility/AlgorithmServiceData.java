...
public class AlgorithmServiceData implements Serializable{
	...
	public String sServiceName = "n/a"; // name to be used in the URL when calling the service
	...
	public String sAnalysisServiceURL = "n/a"; // URL of the server containing the web services e.g. "http://128.220.76.170:8080/axis2/services" used together with sServiceName and sServiceMethod e.g. "http://128.220.76.170:8080/axis2/services/physionetAnalysisService/sqrsWrapperType2"
	public String sServiceMethod = "n/a"; // name of the method, with the webservice. e.g. "sqrsWrapperType2"
